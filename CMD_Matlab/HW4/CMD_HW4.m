%% CMD HW 4 21631211 Cahit Oğuz Saydam
clc,
clear;
clear all;
%% transformation matrix by using sinusoidal function
ti = 0;  %[s] initial time
tf = 2; %[s] final time
...
% Position vectors by using sinusoidal function
...
lr = length(t); % wrist position of length
for i = 1:lr
